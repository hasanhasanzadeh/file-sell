                ...
                <div class="card card-none mt-1 mb-3">
                    <div class="card-body">
                        ...
                        <div class="text-justify text-secondary ft-14">
                            آموزش nodejs از هر زمانی آسان‌تر شده و در این مجلهسعی دارم قدم به قدم node را به شما آموزش دهم. اگر نمیدانید node چیست یا چرا باید آن را یاد بگیرید پیشنهاد می‌کنیم . جلسه ابتدای و بخش اول این مجلهکه به شکل رایگان در اختیار شما قرار دارد را مشاهده کنید.
                ...
                <div class="card card-none card-primary mb-4 mt-1 ft-13">
                    <div class="card-body">
                        <p class="text-justify text-light">
                            برای دسترسی به این مجلهنیاز است بصورت نقدی این مجلهرا خریداری کنید یا با تهیه عضویت ویژه میتوانید به آن دسترسی پیدا کنید.
                        </p>
                        <hr class="bg-light">
                        <div class="table table-responsive text-light ">
                            <table class="w-100 table-borderless">
                                ...
                                <tr class="text-left">
                                    <td class="text-right">زمان کل مجله</td>
                                    <td >2:21:14</td>
                                </tr>
                                <tr class="text-left">
                        ...
                        @foreach($gazettes as  $key=>$gazette)
                            ...
                            <div class="card ">
                                <a href="{{url('/gazettes/'.$gazette->slug)}}">
                                    <img src="{{$gazette->photo->path}}" class="card-img-top img-card-sf" alt="">
                                </a>
                                <div class="card-body">
                                    <a href="{{url('/gazettes/'.$gazette->slug)}}" class="text-decoration-none text-dark">
                                        <h5>
                                            {{$gazette->title}}
                                        </h5>
                                    </a>
                                    <p class="text-muted text-justify">
                                        {!! Str::limit($gazette->description,140)!!}
                                    </p>
                                </div>

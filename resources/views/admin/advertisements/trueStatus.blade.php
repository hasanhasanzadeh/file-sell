...
@section('header')
    <section class="content-header">
        <h1>
            پیشخوان
            <small>آگهی تأیید شده</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{route('panel')}}"><i class="fa fa-tachometer-alt"></i>پیشخوان</a></li>
            <li class="active">آگهی های تأیید شده</li>
        </ol>
    </section>
@endsection
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h4 class="text-center">آگهی های تایید شده</h4>
            <div class="text-left">
                <a href="{{route('advertisements.falseStatus')}}" class="btn btn-app">
                    <i class="fa fa-user-graduate"></i>
                    آگهی های تأیید نشده
                </a>
            </div>
        </div>
        <div class="box-body">
            ...
            @else
                <div class="table-responsive">
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tfoot>
                        <tr>
                            <td colspan="6" class="text-center">{{$advertisements->links()}}</td>
                        </tr>
                        </tfoot>
                    </table>
                </div>
